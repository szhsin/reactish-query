"use strict";
const require_useQueryCore = require("./useQueryCore.cjs");
...
const useLazyQuery$ = (options) => {
	const internalApi = require_useQueryCore.useQueryCore({
		...options,
		enabled: false
	});
	...
	return {
		...
		*/
		trigger: (0, react.useCallback)((args) => fetchFn(args), [fetchFn]),
